...
Begin VB.Form FrmQuestion3 
   ...
   Begin VB.TextBox Txtorangequestion 
      ...
      Left            =   1320
      TabIndex        =   1
      Text            =   "How many dimples are on the average golf ball?"
      Top             =   2040
      Width           =   5175
   End
...
'Objective: Provide question #3
Option Explicit 'Check for errors

'SEE QUESTION 1 FORM FOR COMPLETE COMMENTORY

Private Sub CmdD_Click()
MsgBox ("Sorry, better luck next time, the correct answer is B.  You won 0 dollars.")
...
MsgBox ("Correct, let's move on to the $500 question.")
...
Else
MsgBox ("Your friend thinks C is the right answer, they are 95% sure")
End If
PhoneEnabled = False
CmdPhone.Enabled = False
End Sub
Private Sub CmdAudience_Click()
MsgBox ("Results: A: 45% , B: 50% , C: 5%, D: 0%")
...
MsgBox ("Congratulations on Winning $200")
