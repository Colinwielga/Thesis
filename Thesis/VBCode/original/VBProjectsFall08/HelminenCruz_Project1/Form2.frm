...
Begin VB.Form Form2 
   ...
   Begin VB.CommandButton Command2 
      BackColor       =   &H00FFC0C0&
      Caption         =   "Sort by opercentage frequency in ascending order"
      BeginProperty Font 
         Name            =   "Curlz MT"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton cmdfrequency2 
      BackColor       =   &H00FFC0C0&
      Caption         =   "Sort by opercentage frequency in descending order"
      BeginProperty Font 
         Name            =   "Curlz MT"
         Size            =   8.25
         Charset         =   0
...
picresults1.Print Tab(4); Femalenames(N); Tab(25); femalefrequency(N)
Next N
End Sub
...
picresults1.Print Tab(2); Femalenames(N); Tab(25); femalefrequency(N)
Next N
End Sub
