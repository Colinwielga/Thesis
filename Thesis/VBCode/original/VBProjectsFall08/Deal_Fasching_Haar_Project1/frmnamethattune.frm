...
If LCase(guess) = "what time is it" Then
...
If LCase(guess) = "stick to the status quo" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "bop to the top" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "all for one" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "we're all in this together" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "you are the music in me" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "get your head in the game" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
...
If LCase(guess) = "the start of something new" Then
    MsgBox ("That is correct!!")
    runningtotal = runningtotal + 1
