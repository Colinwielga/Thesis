    ...
    picResults.Cls
       ...
       'if B has the majority of numbers (1-5), then the following message is displayed to the user:
        ...
        'if D has the majority of numbers (1-5), then the following message is displayed to the user:
            picResults.Print "Your pace was a bit too ambitious, as was your rationing."
            picResults.Print "By the third day most of your party couldn't cope with each other"
            picResults.Print "and they fell into a serious bout of fits. Ma wouldn't stop"
            picResults.Print "babbling about making biscuits. Pa thought the Oxen were part"
            picResults.Print "of a new religious order and the baby fell out of the back of "
            picResults.Print "the wagon and was consumed by wolves. Nonetheless, you made it."
            picResults.Print "Welcome to Oregon! "
        ...
        ElseIf (TotalA = TotalB) Then
            ...
            'if the answer to the tie-breaking question is "buffalo" then the following message is displayed to the user:
                ...
                picResults.Print "for pushing into the frontier and being a 'True' American."
                picResults.Print "If it weren't for you we wouldn't be the great country we are"
                picResults.Print "today. Your actions echo the famous song by Woodie Guthrie"
                picResults.Print "'This Land is My Land, this land is NOT your Land'."
                picResults.Print "While those might not be the actual lyrics, you may just get"
                picResults.Print "the drift. You civilized the West. Didnt' you?"
        ...
        'asks the user a tie-breaking question if TotalA = TotalD
            ...
            'if the answer to the tie-breaking question is not "Cool" then the following message is displayed to the user:
                ...
                picResults.Print "your journey didn't go well either."
        ...
        'if the answer to the tie-breaking question is "surprise" then the following message is displayed to the user:
            If LCase(Category) = "Buffalo Bill" Then
                ...
                picResults.Print "next incarnation as maggot."
        ...
        ElseIf (TotalB = TotalD) Then
            ...
            Category = InputBox("You must eat one of your party. Who should it be? Jeremiah or Jud", , "A tasy decision")
            ...
            'if the answer to the tie-breaking question is not "Jud" then the following message is displayed to the user:
                picResults.Print "Jeremiah was meaty fellow and he didn't go down,"
