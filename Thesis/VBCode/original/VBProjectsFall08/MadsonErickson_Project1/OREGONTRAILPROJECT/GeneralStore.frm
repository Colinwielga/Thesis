...
Begin VB.Form Form3 
   ...
   Begin VB.Label lblCost 
      Caption         =   "You have $100 to spend. You must buy an Oxen first."
      BeginProperty Font 
         Name            =   "Californian FB"
         Size            =   14.25
         Charset         =   0
...
'$100 to spend at the store and must buy a minimum of 1 oxen
...
I = txtItem.Text
 Q = txtQuantity.Text
    ...
    If Oxen <> True Then
        If (I) <> 1 Then
        MsgBox ("You must purchase at least one ox. You can't walk to Oregon!")
    ...
    Else
        ...
        End If
            ...
            Else
            MsgBox ("You've spent all your money fool!")
