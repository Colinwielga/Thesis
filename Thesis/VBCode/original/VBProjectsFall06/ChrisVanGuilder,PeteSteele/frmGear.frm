...
'this form displays the price of various baseball equipment and gear.
'The user clicks on the images to add the item to the potential total.
'this form exports the gear total to the shopping cart.
Option Explicit

Private Sub cmdCart_Click()
    frmCart.Visible = True                 'sends gear total to cart
...
End Sub
Private Sub cmdClear_Click() 'clears gear total
    picResultsGear.Cls
    GearSum = 0
End Sub
