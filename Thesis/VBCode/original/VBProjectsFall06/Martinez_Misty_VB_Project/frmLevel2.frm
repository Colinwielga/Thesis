...
Private Sub cmdAnswers_Click()
    ...
    Cat = txtCat.Text
    Horton = txtHorton.Text
    Sam = txtSam.Text
    Grinch = txtGrinch.Text
    Sneetch = txtSneetch.Text
    
    If Cat = "B" And Horton = "E" And Sam = "D" And Grinch = "A" And Sneetch = "C" Then
        MsgBox YourName & " Congratulations You are Correct!!", , "Hooray"
        frmLevel2.Visible = False
