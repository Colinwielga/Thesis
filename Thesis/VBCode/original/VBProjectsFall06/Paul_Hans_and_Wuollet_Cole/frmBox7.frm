VERSION 5.00
Begin VB.Form frmBox7 
   Caption         =   "Box Score From Game 7"
   ClientHeight    =   4170
   ClientLeft      =   3765
   ClientTop       =   3930
   ClientWidth     =   5880
   ...
   Begin VB.Label lblGameNumber 
      ...
      Width           =   615
   End
   Begin VB.Image imgBox7 
      Height          =   5760
      Left            =   0
      Picture         =   "frmBox7.frx":0000
      Top             =   -240
      Width           =   7680
   End
End
Attribute VB_Name = "frmBox7"
...
'Objective: To display the Box Score from Game 7 of the 1987 World Series
Option Explicit
