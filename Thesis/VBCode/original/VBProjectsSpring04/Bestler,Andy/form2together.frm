...
Begin VB.Form Form2 
   ...
   ClientWidth     =   4680
   LinkTopic       =   "Form2"
   Picture         =   "form2together.frx":0000
   ScaleHeight     =   3090
   ScaleWidth      =   4680
...
For x = 1 To 30
    If position(x) = "Defense" Then
    picresults.Print player(x)
    End If
    Next x
    
    'prints pics of players
...
Open "M:\CS130\VB project\position.txt" For Input As #2
For x = 1 To 30
