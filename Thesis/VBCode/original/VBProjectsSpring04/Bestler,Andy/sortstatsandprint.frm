...
Begin VB.Form Form1 
   ...
   ForeColor       =   &H00008000&
   LinkTopic       =   "Form1"
   Picture         =   "sort stats and print.frx":0000
   ScaleHeight     =   3090
   ScaleWidth      =   4680
...
'Minnesota Wild (Bestler, Andy)
'Andy Bestler (form 1)
'Andy Bestler
'March 15, 2004

'the purpose of this program is to analyze and interpret the Minnesota
'Wild's roster and statistics for the 2002-2003 regular season

'The specific purpose of this form is to ananlyze the Minnesota Wild's
'stats and arrange them in any order according to the user
'the user will also be able to select an individual player of analysis
...
Dim x As Integer 'for ctr
Dim n As String 'for player input
Dim found As Boolean
Dim ctr As Integer
Dim pass As Integer
Dim comp As Integer 'for comp
...
For pass = 1 To ctr - 1                 'use a bubble sort to arrange by assists descending
    For comp = 1 To ctr - 1
...
For pass = 1 To ctr - 1                 'uses a bubble sort to arrange by games played descending
    For comp = 1 To ctr - 1
     ...
     'prints players by games played
picresults.Print ; "Player                            jersey#   Games-played   Goals       Assists       Points    Penalty Minutes      +/- "
picresults.Print
For x = 1 To 32
picresults.Print names(x);
...
For pass = 1 To ctr - 1                 'uses a bubble to arrange by goals scored
    For comp = 1 To ctr - 1
     ...
     'prints total roster according to total goals scored
picresults.Print ; "Player                            jersey#   Games-played   Goals       Assists       Points    Penalty Minutes      +/- "
picresults.Print
For x = 1 To 32
picresults.Print names(x);
...
' if name entered in list prints individual stats
    ...
    End If
    Next x
    If found = False Then                   'checks that input is accurate
...
For pass = 1 To ctr - 1             'uses a bubble sort to arrange numerically according to jersey
    For comp = 1 To ctr - 1
     ...
     'prints players according to jersey number
picresults.Print ; "Player                            jersey#   Games-played   Goals       Assists       Points    Penalty Minutes      +/- "
picresults.Print
For x = 1 To 32
picresults.Print names(x);
...
For pass = 1 To ctr - 1             'uses a bubble sort to arrange by penalty minutes
    For comp = 1 To ctr - 1
        ...
        'prints according to total penalty minutes
...
For pass = 1 To ctr - 1             'uses a bubble sort to arrange by plus/minus
    For comp = 1 To ctr - 1
        ...
        'prints roster according to plus minus
...
For pass = 1 To ctr - 1                 ' uses a bubble sort to arrange by points
    For comp = 1 To ctr - 1
        ...
        'prints roster according to points earned
...
picresults.Print Tab(37); games(x); Tab(50); goals(x); Tab(60); assists(x); Tab(70); points(x); Tab(80); penalty(x); Tab(95); plusminus(x)
Next x
cmdjersey.Enabled = True        'enables all hidden buttons
