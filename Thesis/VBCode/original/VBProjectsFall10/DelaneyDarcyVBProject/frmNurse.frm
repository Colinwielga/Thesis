...
'This form is unique to the profession of a nurse. The user obtains the average salary of a nurse, and is
...
'Loads pictures and retrieve salary from array
Private Sub cmdContinue_Click()
    ...
    picWelcome.Print "Your starting salary as a nurse is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "nurse.jpg")
...
'Read file into array and send to cost form
