...
'This form is unique to the profession of a police. The user obtains the average salary of a police, and is
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as a police officer is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "police.jpg")
