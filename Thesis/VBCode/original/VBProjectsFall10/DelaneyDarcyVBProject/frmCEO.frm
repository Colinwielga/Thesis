...
Begin VB.Form frmCEO 
   ...
   End
End
Attribute VB_Name = "frmCEO"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of a CEO. The user obtains the average salary of a CEO, and is
...
'Reveals salary and computational command buttons
Private Sub cmdContinue_Click()
    ...
    picWelcome.Print "Your starting salary as a CEO is " & FormatCurrency(yourSalary) & ""
    picCEO.Picture = LoadPicture(App.Path & "\images\" & "CEO.jpg")
...
Private Sub cmdBack_Click()
    frmCEO.Visible = False
    frmStart.Visible = True
    picCEO.Visible = False
