...
Begin VB.Form frmAthlete 
   ...
   Begin VB.TextBox txtLastName 
      ...
      Width           =   2520
   End
   Begin VB.PictureBox picAthlete 
      BackColor       =   &H00400000&
      Height          =   8535
      Left            =   4920
      ScaleHeight     =   8475
   ...
   End
End
Attribute VB_Name = "frmAthlete"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of Athlete. The user obtains the average salary of an athlete, and is
...
' Reveal salary and command buttons
Private Sub cmdContinue_Click()

    picAthlete.Visible = True
    cmdtax.Visible = True
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as a star professional athlete is " & FormatCurrency(yourSalary) & ""
    picAthlete.Picture = LoadPicture(App.Path & "\images\" & "Athlete.jpg")
...
Private Sub cmdBack_Click()
    frmAthlete.Visible = False
    frmStart.Visible = True
    picAthlete.Visible = False
