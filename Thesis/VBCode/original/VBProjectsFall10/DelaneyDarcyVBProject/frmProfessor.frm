...
Begin VB.Form frmProfessor 
   ...
   End
End
Attribute VB_Name = "frmProfessor"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of a professor. The user obtains the average salary of a Professor, and is
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as a professor is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "professor.jpg")
