...
Begin VB.Form frmPolitician 
   ...
   End
End
Attribute VB_Name = "frmPolitician"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of a Politician. The user obtains the average salary of a politician, and is
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as a politician is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "politician.jpg")
