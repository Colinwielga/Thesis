...
Begin VB.Form frmAccountant 
   ...
   Begin VB.PictureBox picWelcome 
      ...
      Width           =   9495
   End
   Begin VB.PictureBox picAccountant 
      BackColor       =   &H00400000&
      Height          =   8055
      Left            =   4560
      ScaleHeight     =   7995
...
'This form is unique to the profession of Accountant. The user obtains the average salary of an accountant, and is
...
'Loads picture, retrieve salary from array, and computational command buttons
Private Sub cmdContinue_Click()

    picAccountant.Visible = True
    cmdtax.Visible = True
...
'Deciphers user's title according to gender
...
'Prints to picture box
    picWelcome.Cls
    picAccountant.Cls
    picWelcome.Print "Welcome " & S & " " & LastName & ""
    picWelcome.Print "Your starting salary as an accountant is " & FormatCurrency(yourSalary) & ""
    
'Dynamic picture loading to picture box from images file
    picAccountant.Picture = LoadPicture(App.Path & "\images\" & "Accountant.jpg")

'Conceals  interface tools
...
Private Sub cmdBack_Click()
    frmAccountant.Visible = False
    frmStart.Visible = True
    picAccountant.Visible = False
...
'Calculates taxes based on salary
...
'Finds tax bracket according to salary and display to picture box
...
'Calculate taxes as percentage of income
...
'Leads user to the Cost form and reads cost data from file into arrays
...
'load form and hide picture and command buttons
