...
'This form is unique to the profession of a Pilot. The user obtains the average salary of a Pilot, and is
...
'Load pictre, reveal salary, and reveal buttons
Private Sub cmdContinue_Click()
    ...
    picWelcome.Print "Your starting salary as a pilot is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "pilot.jpg")
...
'Read files into array and direct to cost form
