...
Begin VB.Form frmMortician 
   ...
   End
End
Attribute VB_Name = "frmMortician"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of a mortician. The user obtains the average salary of a mortician, and is
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as a mortician is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "mortician.jpg")
...
'Compute disposable income using formula
...
'Read files into arrays and direct user to cost form
