...
Begin VB.Form frmEngineer 
   ...
   End
End
Attribute VB_Name = "frmEngineer"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form is unique to the profession of a engineer. The user obtains the average salary of an engineer, and is
...
Dim Pos As Integer
    ...
    picWelcome.Print "Your starting salary as an engineer is " & FormatCurrency(yourSalary) & ""
    picResults.Picture = LoadPicture(App.Path & "\images\" & "Engineer.jpg")
