...
Begin VB.Form frmWisconsin 
   ...
   End
End
Attribute VB_Name = "frmWisconsin"
...
picOutput.Print Tab(20); Mallards; "Mallard(s),"
...
Open App.Path & "/WisconsinSpecialLimits.txt" For Input As #1
