...
Begin VB.Form frmMIAC_Results 
   ...
   End
End
Attribute VB_Name = "frmMIAC_Results"
...
Private Sub cmdFullResults_Click()
    ...
    Open App.Path & "\miac_team_results.txt" For Input As #1
    Do Until EOF(1)
        CTRteam = CTRteam + 1
    ...
    Open App.Path & "\miac_individual_results.txt" For Input As #2
    Do Until EOF(2)
        CTR = CTR + 1
