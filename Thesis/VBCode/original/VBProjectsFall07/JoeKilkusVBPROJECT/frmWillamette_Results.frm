VERSION 5.00
Begin VB.Form frmWillamette_Results 
   BackColor       =   &H000000FF&
   Caption         =   "Form1"
   ClientHeight    =   8355
   ClientLeft      =   60
   ...
   ClientWidth     =   11535
   LinkTopic       =   "Form1"
   Picture         =   "frmWillamette_Results.frx":0000
   ScaleHeight     =   22590.95
   ScaleMode       =   0  'User
   ScaleWidth      =   28425.89
   ...
   End
End
Attribute VB_Name = "frmWillamette_Results"
...
Private Sub cmdFullResults_Click()
    ...
    Open App.Path & "\willamette_team_results.txt" For Input As #1
    Do Until EOF(1)
        CTRteam = CTRteam + 1
        Input #1, TeamPlace(CTRteam), TeamName(CTRteam), TeamScore(CTRteam)
    Loop
    
    picResults.Print "Place"; Tab(10); "Team"; Tab(33); "Score"
    
    Do While J < CTRteam
        J = J + 1
        picResults.Print TeamPlace(J); Tab(10); TeamName(J); Tab(33); TeamScore(J)
    Loop
    ...
    Open App.Path & "\willamette_individual_results.txt" For Input As #2
    Do Until EOF(2)
        CTR = CTR + 1
        Input #2, place(CTR), runner(CTR), team(CTR), minutes(CTR), seconds(CTR)
    Loop
    
    picResults.Print "Place"; Tab(10); "Name"; Tab(36); "Team"; Tab(55); "Time"
    ...
    Do While I < 10
        I = I + 1
        picResults.Print place(I); Tab(10); runner(I); Tab(36); team(I); Tab(55); minutes(I); ":"; seconds(I)
    Loop
