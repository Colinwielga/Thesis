VERSION 5.00
Begin VB.Form frmJim_Drews_Results 
   BackColor       =   &H000000FF&
   Caption         =   "Form1"
   ClientHeight    =   8355
   ClientLeft      =   60
   ...
   ClientWidth     =   11535
   LinkTopic       =   "Form1"
   Picture         =   "Jim_Drews_Results.frx":0000
   ScaleHeight     =   8355
   ScaleMode       =   0  'User
   ScaleWidth      =   28726.59
   ...
   Begin VB.Label lblColfax 
      BackColor       =   &H000000FF&
      Caption         =   "West Salem, WI 10/13/2007"
      BeginProperty Font 
         Name            =   "Rockwell"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmJim_Drews_Results"
...
Private Sub cmdFullResults_Click()
    ...
    Open App.Path & "\jim_drews_team_results.txt" For Input As #1
    Do Until EOF(1)
        CTRteam = CTRteam + 1
    ...
    picResults.Print "Place"; Tab(10); "Team"; Tab(31); "Score"
    
    Do While J < CTRteam
        J = J + 1
        picResults.Print TeamPlace(J); Tab(10); TeamName(J); Tab(31); TeamScore(J)
    Loop
    ...
    Open App.Path & "\jim_drews_individual_results.txt" For Input As #2
    Do Until EOF(2)
        CTR = CTR + 1
        Input #2, place(CTR), runner(CTR), team(CTR), minutes(CTR), seconds(CTR)
    Loop
    
    picResults.Print "Place"; Tab(10); "Name"; Tab(30); "Team"; Tab(51); "Time"
    ...
    Do While I < 20
        I = I + 1
        picResults.Print place(I); Tab(10); runner(I); Tab(33); team(I); Tab(54); minutes(I); ":"; seconds(I)
    Loop
