VERSION 5.00
Begin VB.Form frmPreNats_Results 
   BackColor       =   &H000000FF&
   Caption         =   "Form1"
   ClientHeight    =   8355
   ClientLeft      =   60
   ...
   ClientWidth     =   11535
   LinkTopic       =   "Form1"
   Picture         =   "PreNats_Results.frx":0000
   ScaleHeight     =   8355
   ScaleWidth      =   11535
   ...
   Begin VB.Label lblColfax 
      BackColor       =   &H000000FF&
      Caption         =   "Northfield, MN 10/6/2007"
      BeginProperty Font 
         Name            =   "Rockwell"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmPreNats_Results"
...
Private Sub cmdFullResults_Click()
    ...
    Open App.Path & "\pre_nats_team_results.txt" For Input As #1
    Do Until EOF(1)
        CTRteam = CTRteam + 1
    ...
    Open App.Path & "\pre_nats_individual_results.txt" For Input As #2
    Do Until EOF(2)
        CTR = CTR + 1
