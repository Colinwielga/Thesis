VERSION 5.00
Begin VB.Form frmSonics 
   BackColor       =   &H00008000&
   Caption         =   "Seattle Supersonics"
   ClientHeight    =   8835
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11085
   LinkTopic       =   "Form1"
   Picture         =   "frmSonics.frx":0000
   ScaleHeight     =   8835
   ScaleWidth      =   11085
   ...
   Begin VB.CommandButton cmdSortPoints 
      ...
      Width           =   1935
   End
   Begin VB.CommandButton cmdShowSonics 
      BackColor       =   &H0000FFFF&
      Caption         =   "Show Seattle Supersonics' Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowSonics_Click()
'open the data file
Open App.Path & "\SonicsNotes.txt" For Input As #12

'get the data
ctr = 0
    Do While Not EOF(12)
        ctr = ctr + 1
        Input #12, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
