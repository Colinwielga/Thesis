VERSION 5.00
Begin VB.Form frmKings 
   BackColor       =   &H00000000&
   Caption         =   "Sacramento Kings"
   ClientHeight    =   8685
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10890
   LinkTopic       =   "Form1"
   Picture         =   "frmKings.frx":0000
   ScaleHeight     =   8685
   ScaleWidth      =   10890
   ...
   Begin VB.PictureBox picresults 
      ...
      Width           =   5895
   End
   Begin VB.CommandButton cmdShowKings 
      BackColor       =   &H00FF00FF&
      Caption         =   "Show Sacramento Kings' Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowKings_Click()
'open the data file
Open App.Path & "\KingsNotes.txt" For Input As #7

'get the data
ctr = 0
    Do While Not EOF(7)
        ctr = ctr + 1
        Input #7, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
