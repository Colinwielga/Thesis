VERSION 5.00
Begin VB.Form frmLakers 
   BackColor       =   &H00800080&
   Caption         =   "Los Angeles Lakers"
   ClientHeight    =   8925
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11055
   LinkTopic       =   "Form1"
   Picture         =   "frmLakers.frx":0000
   ScaleHeight     =   8925
   ScaleWidth      =   11055
   ...
   Begin VB.PictureBox picresults 
      ...
      Width           =   5895
   End
   Begin VB.CommandButton cmdShowLakers 
      BackColor       =   &H0000FFFF&
      Caption         =   "Show Los Angeles Lakers' Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowLakers_Click()
'open the data file
Open App.Path & "\LakersNotes.txt" For Input As #8

'get the data
ctr = 0
    Do While Not EOF(8)
        ctr = ctr + 1
        Input #8, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
