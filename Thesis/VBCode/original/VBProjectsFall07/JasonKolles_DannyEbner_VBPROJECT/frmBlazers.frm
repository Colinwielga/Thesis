VERSION 5.00
Begin VB.Form frmBlazers 
   BackColor       =   &H00000000&
   Caption         =   "Portland Trailblazers"
   ClientHeight    =   8895
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11355
   LinkTopic       =   "Form1"
   Picture         =   "frmBlazers.frx":0000
   ScaleHeight     =   8895
   ScaleWidth      =   11355
   ...
   Begin VB.PictureBox picresults 
      ...
      Width           =   5655
   End
   Begin VB.CommandButton cmdShowBlazers 
      BackColor       =   &H000000FF&
      Caption         =   "Show Portland Trailblazers' Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowBlazers_Click()
'open the data file
Open App.Path & "\BlazersNotes.txt" For Input As #1

'get the data
ctr = 0
    Do While Not EOF(1)
        ctr = ctr + 1
        Input #1, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
