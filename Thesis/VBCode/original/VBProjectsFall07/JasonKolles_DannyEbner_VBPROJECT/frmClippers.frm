VERSION 5.00
Begin VB.Form frmClippers 
   BackColor       =   &H000000FF&
   Caption         =   "Los Angeles Clippers"
   ClientHeight    =   8805
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10890
   LinkTopic       =   "Form1"
   Picture         =   "frmClippers.frx":0000
   ScaleHeight     =   8805
   ScaleWidth      =   10890
   ...
   Begin VB.PictureBox picresults 
      ...
      Width           =   5775
   End
   Begin VB.CommandButton cmdShowClippers 
      BackColor       =   &H00FF0000&
      Caption         =   "Show Los Angeles Clippers' Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowClippers_Click()
'open the data file
Open App.Path & "\ClippersNotes.txt" For Input As #2

'get the data
ctr = 0
    Do While Not EOF(2)
        ctr = ctr + 1
        Input #2, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
