...
Begin VB.Form frmJazz 
   ...
   Begin VB.PictureBox picresults 
      ...
      Width           =   5775
   End
   Begin VB.CommandButton cmdShowJazz 
      BackColor       =   &H00FF0000&
      Caption         =   "Show Utah Jazz's Starters"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdShowJazz_Click()
'open the data file
Open App.Path & "\JazzNotes.txt" For Input As #6

'get the data
ctr = 0
    Do While Not EOF(6)
        ctr = ctr + 1
        Input #6, player(ctr), points(ctr), rebounds(ctr), assists(ctr)
    Loop
