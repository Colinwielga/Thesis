...
Begin VB.Form frmTriads1 
   ...
   Begin VB.Label lblOptions 
      BackColor       =   &H80000012&
      Caption         =   "1)  F major                   2)  F minor                   3)  A minor                   4)  A major"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
ctr = 0         'this starts the counter and total at 0
total = 0

                             'asks the player to type # of correct response, then checks.
...
Else: MsgBox ("Incorrect answer.  The right answer was 1) F Major.  Click the red button to move on to the next question.")
End If
