VERSION 5.00
Begin VB.Form frmComfort10 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Comfort 10 Plan"
   ClientHeight    =   5370
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10815
   ...
   Begin VB.Label lblPunchUse 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "You will receive 10 punches each week and 175 dining bucks for the semester."
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblFoodFight 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Food Fight 2007: Comfort 10 Plan"
      BeginProperty Font 
         Name            =   "Myriad Pro"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmComfort10"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form calculates the week and month when the Comfort 10 Plan will be
...
frmComfort10.Hide           'closes frmComfort10
...
Else:                                                       'If the inputted values are > 0, the program will do the computations as described
    ...
    BucksTotal = 0
    MonthCounterBucks = 0
    Do While BucksTotal < 175                                  'Define Do While condition
    ...
    picResults.Print "You will receive 10 new punches each week."
...
'Gives Details about the Comfort 10 Plan
MsgBox "10 Meals per week & 175 Dining Bucks per semester", , "Comfort 10 Plan Description"
End Sub
...
ElseIf BucksRemainder > 175 Then
    MsgBox "You will have no remaining dining bucks at this time.", , "Meal Plan Exhausted"
Else: BucksRemainder = 175 - BucksNumber * WeekCtrBucks                                     'If the entered string does exit within this range, caculate the number of dining bucks remaining and print this value
