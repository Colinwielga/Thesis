VERSION 5.00
Begin VB.Form frm7DaysAWeek 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Continuous Plan 7 Days Per Week"
   ClientHeight    =   5370
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10755
   ...
   Begin VB.Label lblFoodFight 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Food Fight 2007: Continuous Plan 7 Days a Week"
      BeginProperty Font 
         Name            =   "Myriad Pro"
         Size            =   14.25
         Charset         =   0
   ...
   Begin VB.Label lblStepOne 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   $"frm7DaysPerWeek.frx":0000
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblPunchUse 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "You will receive 75 dining bucks for the semester."
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm7DaysAWeek"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form calculates the week and month when the Continuous Plan 7 Days a Week will be
...
Dim Ctr As Integer, WeeksMonths(1 To 100) As String, MonthCounterBucks As Integer, BucksNumber As Single
...
'returns user to frmChooseContinuousType
frm7DaysAWeek.Hide              'closes frm7DaysAWeek
...
Else:                                                           'If the inputted values are > 0, the program will do the computations as described
    ...
    BucksTotal = 0
    MonthCounterBucks = 0
    Do While BucksTotal < 75                                    'Define Do While condition
    ...
    picResults.Cls
    'Punches are not utilized by this plan, so no calculations are necessary
    picResults.Print "You will have unlimited access to the Refectory and Gorecki Dining Center each week."
    ...
    If MonthCounterBucks > 17 Then
        ...
        ElseIf BucksNumber > 75 Then                                                                            'Prints error statement if BucksNumber exceeds plan's allotted number of dining bucks
...
'Describes the 7 Days a Week Plan in detail
Private Sub cmdDescription_Click()
MsgBox "This plan allows students to enter the SJU Refectory or the Gorecki Center as often as they choose 7 days a week during operating hours.   The continuous pass portion of this plan is only valid at the SJU Refectory and the Gorecki Center.  Included in this plan are 75 Dining Bucks per semester and 4 free guest passes per semester.", , "Continuous Plan 7 Days a Week Description"
End Sub
...
ElseIf BucksRemainder > 75 Then
    MsgBox "You will have no remaining dining bucks at this time.", , "Meal Plan Exhausted"
Else: BucksRemainder = 75 - BucksNumber * WeekCtrBucks                                     'If the entered string does exit within this range, caculate the number of dining bucks remaining and print this value
