...
Begin VB.Form frmBlockPlan 
   ...
   Begin VB.Label lblFoodFight 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Food Fight 2007: Block Plan"
      BeginProperty Font 
         Name            =   "Myriad Pro"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBlockPlan"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form calculates the week and month when the Block Plan will be exhausted of
...
Dim Ctr As Integer, WeeksMonths(1 To 100) As String, PunchNumber As Double, BucksNumber As Double, MonthCounterPunches As Integer, MonthCounterBucks As Single
...
'Returns user to the Start Page
frmBlockPlan.Hide       'closes frmBlockPlan
frmStartPage.Show       'opens frmStartPage
End Sub

Private Sub cmdCalculate_Click()
'define extra variables
Dim PunchTotal As Double, BucksTotal As Double
...
Else:                                                           'If the inputted values are > 0, the program will do the computations as described
    ...
    If chkFall.Value = 1 Then                                   'chkFall loads file of fall weeks and months, to be searched later
        ...
        Loop                                                    'Repeat until all dat is loaded
        Close #1                                                'Close FallSchedule.txt when done reading data into array WeeksMonths
    ...
    If MonthCounterPunches > 17 Then
        ...
        ElseIf PunchNumber > 150 Then                                                                       'Prints error statement if PunchNumber exceeds plan's allotted number of punches
    ...
    If MonthCounterBucks > 17 Then
        ...
        ElseIf BucksNumber > 175 Then                                                                        'Prints error statement if BucksNumber exceeds plan's allotted number of dining bucks
...
MsgBox "Plan gives students flexibility by providing 150 meals per semester versus meals per week.  This plan includes 175 Dining Bucks for the semester.", , "Block Plan Description"
End Sub
...
PunchRemainder = 150 - PunchNumber * WeekCtrPunches
BucksRemainder = 175 - BucksNumber * WeekCtrBucks
