VERSION 5.00
Begin VB.Form frmComfort7 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Comfort 7 Plan"
   ClientHeight    =   5340
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10830
   ...
   Begin VB.Label lblPunchUse 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "You will recieve 7 punches each week and 300 dining bucks for the semester."
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblFoodFight 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Food Fight 2007: Comfort 7 Plan"
      BeginProperty Font 
         Name            =   "Myriad Pro"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmComfort7"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form calculates the week and month when the Comfort 7 Plan will be
...
frmComfort7.Hide            'closes frmComfort7
...
Else:                                                       'If the inputted values are > 0, the program will do the computations as described
    ...
    BucksTotal = 0
    MonthCounterBucks = 0
    Do While BucksTotal < 300                                  'Define Do While condition
    ...
    picResults.Print "You will receive 7 new punches each week."
    ...
    If MonthCounterBucks > 17 Then
        ...
        ElseIf BucksNumber > 300 Then                                                                           'Prints error statement if BucksNumber exceeds plan's allotted number of dining bucks
...
'Gives Details about the Comfort 7 Plan
MsgBox "7 Meals per week & 300 Dining Bucks per semester ", , "Comfort 7 Plan Description"
End Sub
...
ElseIf BucksRemainder > 300 Then
    MsgBox "You will have no remaining dining bucks at this time.", , "MealPlan Exhausted"
Else: BucksRemainder = 300 - BucksNumber * WeekCtrBucks                                     'If the entered string does exit within this range, caculate the number of dining bucks remaining and print this value
