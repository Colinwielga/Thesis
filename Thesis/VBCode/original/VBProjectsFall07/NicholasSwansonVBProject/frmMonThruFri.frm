VERSION 5.00
Begin VB.Form frmMonThruFri 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Continuous Plan Monday Thru Friday"
   ClientHeight    =   5355
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10755
   ...
   Begin VB.Label lblPunchUse 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "You will receive 150 dining bucks for the semester."
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblStepOne 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   $"frmMonThruFri.frx":0000
      BeginProperty Font 
         Name            =   "Myriad Condensed Web"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label lblFoodFight 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Food Fight 2007: Continuous Plan Monday Thru Friday"
      BeginProperty Font 
         Name            =   "Myriad Pro"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmMonThruFri"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form calculates the week and month when the Continuous Plan Monday Thru Friday will be
...
frmMonThruFri.Hide              'closes frmMonThruFri
...
Else:                                                           'If the inputted values are > 0, the program will do the computations as described
    ...
    BucksTotal = 0
    MonthCounterBucks = 0
    Do While BucksTotal < 150                                   'Define Do While condition
    ...
    picResults.Print "You will have unlimited access, Monday through Friday of each week, to the Refectory"
    picResults.Print "          and Gorecki Dining Center."
    ...
    If MonthCounterBucks > 17 Then
        ...
        ElseIf BucksNumber > 150 Then                                                                            'Prints error statement if BucksNumber exceeds plan's allotted number of dining bucks
...
'Describes Continuous Plan Monday Thru Friday in detail
Private Sub cmdDescription_Click()
MsgBox "This plan allows students to enter the SJU Refectory or the Gorecki Center as often as they choose Monday thru Friday during operating hours.   The continuous pass portion of this plan is only valid at the SJU Refectory and the Gorecki Center.  Included in this plan is 150 Dining Bucks per semester and 4 free guest passes per semester", , "Continuous Plan Monday Thru Friday Description"
End Sub
...
ElseIf BucksRemainder > 150 Then
    MsgBox "You will have no remaining dining bucks at this time.", , "Meal Plan Exhausted"
Else: BucksRemainder = 150 - BucksNumber * WeekCtrBucks                                     'If the entered string does exit within this range, caculate the number of dining bucks remaining and print this value
