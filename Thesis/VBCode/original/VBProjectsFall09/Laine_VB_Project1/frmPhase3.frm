VERSION 5.00
Begin VB.Form frmPhase3 
   BackColor       =   &H80000012&
   Caption         =   "Pole Vaulting pg.3"
   ClientHeight    =   9495
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10905
...
'Aaron Laine
'10/19/09
'This Phase Allows the reader to Enter a height into the text box so that It can tell you how good you are and what you would rank in the MIAC. After that it ends the Project.'
Option Explicit
Dim ctr2 As Integer
...
Private Sub cmdRank_Click()
 ...
 Dim n As Integer
    ...
    'Gets the place the Vaulter would have taken had they been in the MIAC
    feet = feet / 3.2808399
