...
' variables used'
  Dim J As Integer, Avg As Single
    ...
    'calculate and print the average yards gained by all Vaulters'
    Avg = runningtotal / ctr
    picResults.Print "Average Height of Vaulters = "; "   "; FormatNumber(Avg, 3)
    picResults.Print "**************************************"
    
    'print the Vaulters who have gained more than the average amount of yards'
    ...
    'disable the command button for printing above average runners
