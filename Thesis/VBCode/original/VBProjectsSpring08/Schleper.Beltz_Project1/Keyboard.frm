...
' these sets of code allow the user to type into the textbox or click the
' the buttons to enter the following letter.
txtMessage.Text = txtMessage.Text & CMDA(Index).Caption
End Sub

Private Sub cmdAdd_Click()
' this incorporates the module, and uses the global variable
'  so all forms can use it.
