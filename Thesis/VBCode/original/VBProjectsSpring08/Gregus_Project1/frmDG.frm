...
Begin VB.Form frmDG 
   ...
   Begin VB.Label lblLife 
      BackColor       =   &H00000000&
      Caption         =   "*How he's going to save the world: Defeat ignorance / apathy on campus with award-winning Visual Basic project."
      BeginProperty Font 
         Name            =   "Gill Sans Ultra Bold Condensed"
         Size            =   14.25
         Charset         =   0
...
'Dan Gregus
'3/27/08
'Objective: To create a  profile page for Dan Gregus that can be linked to the team bio page
