VERSION 5.00
Begin VB.Form frmchicagoregion 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Form1"
   ClientHeight    =   3630
   ClientLeft      =   60
   ...
   Begin VB.PictureBox picResults 
      ...
      Width           =   3255
   End
   Begin VB.CommandButton cmdsortbyrank 
   ...
   End
End
Attribute VB_Name = "frmchicagoregion"
...
Private Sub cmdback_Click()
    frmchicagoregion.Visible = False
...
Private Sub cmdsortbyrank_Click()
