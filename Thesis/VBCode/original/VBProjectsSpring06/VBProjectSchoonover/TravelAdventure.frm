VERSION 5.00
Begin VB.Form frmAdventureVacation 
   BackColor       =   &H000000C0&
   Caption         =   "Schoonover - Adventure Vacation"
   ClientHeight    =   7545
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10095
   ...
   Begin VB.CommandButton cmdSpecials 
      BackColor       =   &H0000FF00&
      Caption         =   "See Adventure Vacation Airfare Specials!"
      BeginProperty Font 
         Name            =   "Kristen ITC"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAdventureVacation"
...
'Objective:
    ...
    'are willing to spend per person on an action vacation.  Also, they can enter
...
'Read the input file
Open App.Path & "\AdventureVacations.txt" For Input As #1
Pos = 0
Do Until EOF(1)
    Pos = Pos + 1
...
Dim Pos As Integer
picOutput.Cls
picOutput.Print "Adventure Vacation Specials For This Week:"
Open App.Path & "\WeeklyAdventureSpecials.txt" For Input As #1
Pos = 0
Do Until EOF(1)
    Pos = Pos + 1
