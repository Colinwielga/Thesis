VERSION 5.00
Begin VB.Form frmHikingVacation 
   BackColor       =   &H00004000&
   Caption         =   "Schoonover - Hiking Vacation"
   ClientHeight    =   7290
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10170
   ...
   Begin VB.CommandButton cmdSpecials 
      BackColor       =   &H0000FF00&
      Caption         =   "See Hiking Vacation Airfare Specials!"
      BeginProperty Font 
         Name            =   "Kristen ITC"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmHikingVacation"
...
'Form Name: frmHikingVacation (TravelHiking.frm)
'Author: Nicole Schoonover
'Date: Friday, March 24, 2006
'Objective:
    'This form allows users to identify the maximum amount of money they
    'are willing to spend per person on a hiking vacation.  Also, they can enter
...
'Read the input file
Open App.Path & "\HikingVacations.txt" For Input As #1
Pos = 0
Do Until EOF(1)
    Pos = Pos + 1
...
'Display the weekly specials by reading the appropriate input file
    ...
    Dim Pos As Integer
    picOutput.Cls
    picOutput.Print "Hiking Vacation Specials For This Week:"
    Open App.Path & "\WeeklyHikingSpecials.txt" For Input As #1
    Pos = 0
    Do Until EOF(1)
        Pos = Pos + 1
