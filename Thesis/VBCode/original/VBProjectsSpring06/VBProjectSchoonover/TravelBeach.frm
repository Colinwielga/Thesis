VERSION 5.00
Begin VB.Form frmBeachVacation 
   BackColor       =   &H0080FFFF&
   Caption         =   "Schoonover - Beach Vacation"
   ClientHeight    =   7230
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10080
   ...
   Begin VB.CommandButton cmdSpecials 
      BackColor       =   &H0000FF00&
      Caption         =   "See Beach Vacation Airfare Specials!"
      BeginProperty Font 
         Name            =   "Kristen ITC"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBeachVacation"
...
'Form Name: frmBeachVacation (TravelBeach.frm)
'Author: Nicole Schoonover
'Date: Friday, March 24, 2006
'Objective:
    'This form allows users to identify the maximum amount of money they
    'are willing to spend per person on a beach vacation.  Also, they can enter
...
'Read the input file
Open App.Path & "\BeachVacations.txt" For Input As #1
Pos = 0
Do Until EOF(1)
    Pos = Pos + 1
...
'and number of nights and do the corresponding action to the value
For Pos = 1 To Size
...
Dim Pos As Integer
picOutput.Cls
picOutput.Print "Beach Vacation Specials For This Week:"
Open App.Path & "\WeeklyBeachSpecials.txt" For Input As #1
Pos = 0
Do Until EOF(1)
    Pos = Pos + 1
