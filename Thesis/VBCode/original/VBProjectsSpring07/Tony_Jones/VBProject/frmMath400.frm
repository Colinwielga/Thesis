VERSION 5.00
Begin VB.Form frmMath400 
   BackColor       =   &H00FF0000&
   Caption         =   "Derivatives for $400"
   ClientHeight    =   3240
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8760
   ...
   Begin VB.CommandButton cmdNoBuzzMath400 
      BackColor       =   &H0000FF00&
      ...
      Width           =   3495
   End
   Begin VB.CommandButton cmdBuzzMath400 
      BackColor       =   &H0000FF00&
      Caption         =   "Buzz In"
      BeginProperty Font 
         Name            =   "Times New Roman"
...
Private Sub cmdBuzzMath400_Click()

    'Declaring local variables
    Dim QuestionMath400 As String
    Dim CorrectMath400 As String
    
    'Asking user for question and declaring correct question
    QuestionMath400 = InputBox("Enter your question", "Question to Derivatives for $400")
    CorrectMath400 = CorrectQuestions(12)
    
    'Comparing user's question with correct question
    If LCase(QuestionMath400) = LCase(CorrectMath400) Then
        Winnings = Winnings + 400
        MsgBox "That is the correct question", , "Correct Question"
    Else
        Winnings = Winnings - 400
        MsgBox "That is incorrect. The correct question is" & " " & CorrectQuestions(12), , "Incorrect Question"
    End If
...
Private Sub cmdNoBuzzMath400_Click()

    'Lets the user know the correct answer and that he/she does not gain or lose any money
    MsgBox "The correct question is" & " " & CorrectQuestions(12) & "." & " " & "You do not gain any money or lose any money!!!", , "Correct Question"
