VERSION 5.00
Begin VB.Form frmMath1000 
   BackColor       =   &H00FF0000&
   Caption         =   "Derivatives for $1000"
   ClientHeight    =   3375
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8745
   ...
   Begin VB.CommandButton cmdNoBuzzMath1000 
      BackColor       =   &H0000FF00&
      ...
      Width           =   3495
   End
   Begin VB.CommandButton cmdBuzzMath1000 
      BackColor       =   &H0000FF00&
      Caption         =   "Buzz In"
      BeginProperty Font 
         Name            =   "Times New Roman"
...
Private Sub cmdBuzzMath1000_Click()
    'Declaring local variables
    Dim QuestionMath1000 As String
    Dim CorrectMath1000 As String
    
    'Asking user for question and declaring correct question
    QuestionMath1000 = InputBox("Enter your question", "Question to Derivatives for $1000")
    CorrectMath1000 = CorrectQuestions(15)
    
    'Comparing user's question with correct question
    If LCase(QuestionMath1000) = LCase(CorrectMath1000) Then
        Winnings = Winnings + 1000
        MsgBox "That is the correct question", , "Correct Question"
    Else
        Winnings = Winnings - 1000
        MsgBox "That is incorrect. The correct question is" & " " & CorrectQuestions(15), , "Incorrect Question"
    End If
...
Private Sub cmdNoBuzzMath1000_Click()

    'Lets the user know the correct answer and that he/she does not gain or lose any money
    MsgBox "The correct question is" & " " & CorrectQuestions(15) & "." & " " & "You do not gain any money or lose any money!!!", , "Correct Question"
