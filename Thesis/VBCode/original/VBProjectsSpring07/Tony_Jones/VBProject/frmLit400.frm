VERSION 5.00
Begin VB.Form frmLit400 
   BackColor       =   &H00FF0000&
   Caption         =   "Literature Authors for $400"
   ClientHeight    =   2550
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8760
   ...
   Begin VB.CommandButton cmdNoBuzzLit400 
      BackColor       =   &H0000FF00&
      ...
      Width           =   3495
   End
   Begin VB.CommandButton cmdBuzzLit400 
      BackColor       =   &H0000FF00&
      Caption         =   "Buzz In"
      BeginProperty Font 
         Name            =   "Times New Roman"
...
Private Sub cmdBuzzLit400_Click()

    'Declaring local variables
    Dim QuestionLit400 As String
    Dim CorrectLit400 As String
    
    'Asking user for question and declaring correct question
    QuestionLit400 = InputBox("Enter your question", "Question to Literature Authors for $400")
    CorrectLit400 = CorrectQuestions(2)
    
    'Comparing user's question with correct question
    If LCase(QuestionLit400) = LCase(CorrectLit400) Then
        Winnings = Winnings + 400
        MsgBox "That is the correct question", , "Correct Question"
    Else
        Winnings = Winnings - 400
        MsgBox "That is incorrect. The correct question is" & " " & CorrectQuestions(2), , "Incorrect Question"
    End If
...
Private Sub cmdNoBuzzLit400_Click()

    'Lets the user know the correct answer and that he/she does not gain or lose any money
    MsgBox "The correct question is" & " " & CorrectQuestions(2) & "." & " " & "You do not gain any money or lose any money!!!", , "Correct Question"
