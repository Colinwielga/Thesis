VERSION 5.00
Begin VB.Form frmLit200 
   BackColor       =   &H00FF0000&
   Caption         =   "Literature Authors for $200"
   ClientHeight    =   2655
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8835
   ...
   Begin VB.CommandButton cmdNoBuzzLit200 
      BackColor       =   &H0000FF00&
      ...
      Width           =   3495
   End
   Begin VB.CommandButton cmdBuzzLit200 
      BackColor       =   &H0000FF00&
      Caption         =   "Buzz In"
      Height          =   1215
      Left            =   720
      ...
      Width           =   3495
   End
   Begin VB.Label lblLit200 
      Alignment       =   2  'Center
      BackColor       =   &H00FF0000&
      Caption         =   """To Be or not to Be that is the Question"""
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   26.25
         Charset         =   0
...
Private Sub cmdBuzzLit200_Click()

    'Declaring local variables
    Dim QuestionLit200 As String
    Dim CorrectLit200 As String

    'Asking user for question and declaring correct question
    QuestionLit200 = InputBox("Enter your question", "Question to Literature Authors for $200")
    CorrectLit200 = CorrectQuestions(1)
    
    'Comparing user's question with correct question
    If LCase(QuestionLit200) = LCase(CorrectLit200) Then
        Winnings = Winnings + 200
        MsgBox "That is the correct question", , "Correct Question"
    Else
        Winnings = Winnings - 200
        MsgBox "That is incorrect. The correct question is" & " " & CorrectQuestions(1), , "Incorrect Question"
    End If
...
Private Sub cmdNoBuzzLit200_Click()

    'Lets the user know the correct answer and that he/she does not gain or lose any money
    MsgBox "The correct question is" & " " & CorrectQuestions(1) & "." & " " & "You do not gain any money or lose any money!!!", , "Correct Question"
