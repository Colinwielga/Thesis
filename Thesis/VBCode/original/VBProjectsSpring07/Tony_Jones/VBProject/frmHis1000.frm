VERSION 5.00
Begin VB.Form frmHis1000 
   BackColor       =   &H00FF0000&
   Caption         =   "History for $1000"
   ClientHeight    =   7365
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8730
   ...
   Begin VB.CommandButton cmdNoBuzzHis1000 
      BackColor       =   &H0000FF00&
      ...
      Width           =   3495
   End
   Begin VB.CommandButton cmdBuzzHis1000 
      BackColor       =   &H0000FF00&
      Caption         =   "Buzz In"
      BeginProperty Font 
         Name            =   "Times New Roman"
   ...
   Begin VB.Label lblHis1000 
      Alignment       =   2  'Center
      BackColor       =   &H00FF0000&
      Caption         =   "The year Gettysburg took place"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   26.25
         Charset         =   0
      ...
      Width           =   8775
   End
   Begin VB.Image imgGettysburg 
      Height          =   4800
      Left            =   0
      Picture         =   "frmHis1000.frx":0000
      Top             =   0
      Width           =   9000
   End
End
Attribute VB_Name = "frmHis1000"
...
Private Sub cmdBuzzHis1000_Click()
    
    'Declaring local variables
    Dim QuestionHis1000 As String
    Dim CorrectHis1000 As String
    
    'Asking user for question and declaring correct question
    QuestionHis1000 = InputBox("Enter your question", "Question to History for $1000")
    CorrectHis1000 = CorrectQuestions(10)
    
    'Comparing user's question with correct question
    If LCase(QuestionHis1000) = LCase(CorrectHis1000) Then
        Winnings = Winnings + 1000
        MsgBox "That is the correct question", , "Correct Question"
    Else
        Winnings = Winnings - 1000
        MsgBox "That is incorrect. The correct question is" & " " & CorrectQuestions(10), , "Incorrect Question"
    End If
...
Private Sub cmdNoBuzzHis1000_Click()
    
    'Lets the user know the correct answer and that he/she does not gain or lose any money
    MsgBox "The correct question is" & " " & CorrectQuestions(10) & "." & " " & "You do not gain any money or lose any money!!!", , "Correct Question"
