...
'Calculate the deal
Average8 = Int(Total / 3 / 1.25)

'Display the deal and previous deals in the picture boxes on the board form
frmBoard.picOffer.Print FormatCurrency(Average8, 0)
