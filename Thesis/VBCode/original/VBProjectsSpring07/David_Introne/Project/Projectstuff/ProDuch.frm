...
Begin VB.Form Produch 
   ...
   Begin VB.Image Image1 
      Height          =   4815
      Left            =   0
      Picture         =   "ProDuch.frx":3FB7B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7215
   End
End
Attribute VB_Name = "Produch"
