VERSION 5.00
Begin VB.Form frmreviewcase2b 
   BackColor       =   &H00000000&
   Caption         =   "Review Case 2"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmreviewcase2b"
...
For ctr = 19 To 35 'range i want to program to print
