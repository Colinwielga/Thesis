...
Begin VB.Form FrmGame5 
   ...
   Begin VB.Label lblscore 
      Alignment       =   2  'Center
      BackColor       =   &H00C0C0FF&
      Caption         =   "Three points will be subracted from 100 for every mismatch."
      Height          =   375
      Left            =   9240
      TabIndex        =   44
      Top             =   10200
