...
'Form name = frmRace(
Option Explicit
Dim registration(25, 6) As String, y As Integer, j As Integer, temparray(25, 6) As String, x As Integer, racers As Integer

Private Sub cmdbike_Click()
    picpicture.Visible = True
    picpicture.Picture = LoadPicture("M:\My Documents\My Pictures\bike program.jpg")
...
Private Sub cmdEntry_Click()
    ...
    Open "M:\CS130\VBproject\registration done.txt" For Output As #1
        For j = 1 To 25
            name = InputBox("Enter the participant's name", "Entry") 'gets person's name
            ...
            End If
            Write #1, registration(j, 3), registration(j, 4), registration(j, 5), registration(j, 6)
        Next j
        j = j - 1
    picconfirm.Cls
...
Private Sub cmdResults_Click()
    ...
    Open "M:\CS130\VBproject\sort by time.txt" For Output As #2
    Open "M:\CS130\vbproject\registration.txt" For Input As #1
    Do While Not EOF(1)
        x = x + 1
...
Private Sub cmdski_Click()
    picpicture.Visible = True
    picpicture.Picture = LoadPicture("M:\My Documents\My Pictures\skiier program.jpg")
    cmdski.Visible = False
    cmdbike.Visible = False
    cmdentry.Visible = True
    picconfirm.Visible = True
...
Open "M:\CS130\VBproject\sort by age.txt" For Output As #3
ctr = 0
    For ctr = 1 To x - 1
        For pass = 1 To x - ctr
...
picconfirm.Cls
Open "M:\CS130\VBproject\sort by city.txt" For Output As #4
ctr = 0
    For ctr = 1 To x - 1
        For pass = 1 To x - ctr
...
Dim temp5 As String, temp6 As Single, pass As Integer, n As Integer
picconfirm.Cls
Open "M:\CS130\VBproject\sort by name.txt" For Output As #5
ctr = 0
    For ctr = 1 To x - 1
        For pass = 1 To x - ctr
...
Dim ctr As Integer, temp1 As Single, temp2 As Single, temp3 As Single, temp4 As String
Dim temp5 As String, temp6 As Single, pass As Integer, n As Integer
Open "M:\CS130\VBproject\sort by number.txt" For Output As #6
picconfirm.Cls
ctr = 0
    For ctr = 1 To x - 1
        For pass = 1 To x - ctr
