...
D = InputBox("What is the October Date? Only enter the number of the day specified.", "Enter Date") 'ask october date user wants to withdraw money on
...
Open Menu.Path & "VB 10-21-02\Demstxt.txt" For Input As #1 'open file
...
If Balance(D) > M Then 'checking if club has enough money to subtract that withdrawal
        ...
        picResults.Print "The College Democrats Club has enough money to cover this. The new balance is "; FormatCurrency(Sum)
        'printing new balance
    Else
        picResults.Print "The College Democrats Club does not have enough money to cover this expense."
