...
Begin VB.Form thirddegree6 
   BackColor       =   &H80000007&
   Caption         =   "And now for some tough questions..."
   ClientHeight    =   5535
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6765
...
'adds all factors confirmed by the user
...
If weapon.Value = 1 Then
    If rival = opponentname(1) Then sum = sum - 20 'if the opponent is the President, weapons put you at a disadvantage
        Else
            sum = sum + 5
    End If
