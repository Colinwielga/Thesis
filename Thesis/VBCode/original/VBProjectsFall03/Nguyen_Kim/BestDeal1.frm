...
Begin VB.Form frmBestCar 
   ...
   Begin VB.CommandButton cmdAccending 
      Caption         =   "List the Price of The Car In Accending Order"
      Height          =   495
      Left            =   6000
      TabIndex        =   35
      Top             =   8280
   ...
   Begin VB.CommandButton cmdBestCar 
      Caption         =   "Which 3 Cars Do You Think an Enthusiast Would Buyl"
      Height          =   615
      Left            =   8280
      TabIndex        =   21
      Top             =   7440
...
Open "M:\CS130\Nguyen_Kim\PathCars.txt" For Input As #2
For I = 1 To 10
