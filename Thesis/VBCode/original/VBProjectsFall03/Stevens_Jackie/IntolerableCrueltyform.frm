VERSION 5.00
Begin VB.Form IntolerableCruelty 
   BackColor       =   &H00800080&
   Caption         =   "Intolerable Cruelty"
   ClientHeight    =   7590
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11070
   ...
   Begin VB.PictureBox Picture1 
      Height          =   6375
      Left            =   240
      Picture         =   "IntolerableCrueltyform.frx":0000
      ScaleHeight     =   6315
      ScaleWidth      =   4275
      TabIndex        =   0
      Top             =   240
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00800080&
      Caption         =   $"IntolerableCrueltyform.frx":870F
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "IntolerableCruelty"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Project Name: MovieProject (MoveProject.vbp)
'Form Name: IntolerableCruelty (IntolerableCrueltyform.frm)
