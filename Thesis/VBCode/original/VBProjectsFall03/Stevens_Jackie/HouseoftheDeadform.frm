VERSION 5.00
Begin VB.Form HouseoftheDead 
   BackColor       =   &H00800080&
   Caption         =   "House of the Dead"
   ClientHeight    =   8430
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11790
   ...
   Begin VB.PictureBox Picture1 
      Height          =   6375
      Left            =   240
      Picture         =   "HouseoftheDeadform.frx":0000
      ScaleHeight     =   6315
      ScaleWidth      =   4275
      TabIndex        =   0
      Top             =   480
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00800080&
      Caption         =   $"HouseoftheDeadform.frx":4615
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "HouseoftheDead"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Project Name: MovieProject (MoveProject.vbp)
'Form Name: HouseoftheDead (HouseoftheDeadform.frm)
