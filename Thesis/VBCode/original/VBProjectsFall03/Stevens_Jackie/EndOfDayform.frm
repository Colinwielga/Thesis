...
'Form Name: EndOfDay (EndOfDayform.frm)
'Author: Jackie Stevens
'Date Written: 10/20/03
'Purpose: 1. To display the totals that the individual movies made throughout
            'the day in order to see which movie is the most popular and display
            'the total for the entire day to see how much money the user should
            'have.
...
picResults.Print Movie(18); "="; Tab(70); FormatCurrency(MovieTotal18)
