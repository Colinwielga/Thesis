...
Begin VB.Form BridgetForm 
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Guess Bridget's Favorite Color"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Hometown: Lino Lakes, MN Team:  Regional Team      Age: 19"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdCalc_Click()
    ...
    Else: MsgBox "Incorrect!  Bridget's Favorite Color is Blue", , "Sorry!"
    End If
End Sub
