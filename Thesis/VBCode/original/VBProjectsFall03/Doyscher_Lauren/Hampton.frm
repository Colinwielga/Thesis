...
Begin VB.Form HamptonForm 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Hometown: Woodbury, MN   Team: Regional                    Age: 19"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdCalc_Click()
    ...
    Else: MsgBox "Incorrect!  Heather's Favorite Color is Yellow", , "Sorry!"
    End If
End Sub
