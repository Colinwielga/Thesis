...
Begin VB.Form JenniForm 
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Guess Jenni's Favorite Color"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Hometown: St. Cloud, MN  Team: National                     Age: 20"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdCalc_Click()
    ...
    Else: MsgBox "Incorrect!  Jenni's Favorite Color is Purple", , "Sorry!"
    End If
End Sub
