...
Begin VB.Form KariForm 
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Guess Kari's Favorite Color"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Hometown: Eden Prairie, MN Team: National                     Age: 20"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "KariForm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'This form shows Kari's information
Option Explicit
'Project Name: SophmoreDancers (VBProject.vbp)
'Form Name: KariForm (Kari.frm)
...
Private Sub cmdCalc_Click()
    ...
    Else: MsgBox "Incorrect!  Kari's Favorite Color is Purple", , "Sorry!"
    End If
End Sub
