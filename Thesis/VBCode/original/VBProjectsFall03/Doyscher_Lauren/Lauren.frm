...
Begin VB.Form LaurenForm 
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Guess Lauren's Favorite Color"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Hometown: Baxter, MN Team: National             Age: 19"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
...
Private Sub cmdCalc_Click()
    ...
    Else: MsgBox "Incorrect!  Lauren's Favorite Color is Green", , "Sorry!"
    End If
End Sub

Private Sub cmdMainForm_Click()
'Brings you Main Page
LaurenForm.Hide
MainForm.Show
End Sub
