...
Begin VB.Form frmBlackJack 
   ...
   Begin VB.Label lblAuthor 
      ...
      Caption         =   "Tim Johnson   3/20    To let the user have some fun after i have done some serious programming"
      Height          =   615
      Left            =   12960
      TabIndex        =   33
      Top             =   9480
...
Private Sub cmdHonorForm_Click()                    'go back to the Vegas form

frmVegas.Show                                       'go back to the Vegas form
frmBlackJack.Hide                                   'hide black jack
