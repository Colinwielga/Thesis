...
Begin VB.Form frmLittleTotal 
   ...
   End
End
Attribute VB_Name = "frmLittleTotal"
...
Private Sub cmdTotal_Click()
    picResults.Print "Service"; Tab(20); LServiceCTR
    picResults.Print "Social"; Tab(20); LSocialCTR
    picResults.Print "Meetings"; Tab(20); LMeetingCTR
    picResults.Print "*********************************************************"
    picResults.Print
    ...
    Select Case Runningtotal
        ...
        Case Is <= 74
            picResults.Print "Better attend some events. We gotta be at 150 points at the end of the semester!"
    End Select
End Sub
