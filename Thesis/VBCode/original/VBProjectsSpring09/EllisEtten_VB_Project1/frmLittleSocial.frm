...
Begin VB.Form frmLittleSocial 
   ...
   End
End
Attribute VB_Name = "frmLittleSocial"
...
Dim points As Integer
    ...
    Else
        LSocialCTR = points * 10
        Runningtotal = Runningtotal + LSocialCTR
        picResults.Print "You have"; LSocialCTR; "service points."
    End If
...
Private Sub cmdMeeting_Click()
    frmLittleMeetings.Show
    frmLittleSocial.Hide
End Sub
