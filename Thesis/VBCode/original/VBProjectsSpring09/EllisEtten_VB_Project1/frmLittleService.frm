VERSION 5.00
Begin VB.Form frmLittleService 
   BackColor       =   &H00C0C0FF&
   Caption         =   "Form1"
   ClientHeight    =   8775
   ClientLeft      =   60
   ...
   End
End
Attribute VB_Name = "frmLittleService"
...
Private Sub cmdGotoSocial_Click()
    frmLittleSocial.Show
    frmLittleService.Hide
End Sub
...
Dim points As Integer
    ...
    Else
        ...
        LServiceCTR = Runningtotal
        picResults.Print "You have"; LServiceCTR; "service points."
    End If
