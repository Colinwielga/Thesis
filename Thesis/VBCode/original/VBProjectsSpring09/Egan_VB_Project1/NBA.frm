...
'frmNBA (National Basketball Association)
'Written by: Sean Egan
'Written on: 3/20/09
'This form allows the user to bet on pro basketball games.
...
Private Sub cmdDisplay_Click()
    ...
    'Open the file
    Open App.Path & "\NBAGames.txt" For Input As #1
