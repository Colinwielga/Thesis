VERSION 5.00
Begin VB.Form frmBPL 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Barclays Premier League (England)"
   ClientHeight    =   6225
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8040
   ...
   Begin VB.PictureBox picManUtd 
      Height          =   1695
      Left            =   5400
      Picture         =   "BPL.frx":0000
      ScaleHeight     =   1635
      ScaleWidth      =   1635
      TabIndex        =   14
      Top             =   4080
      Width           =   1695
   End
   Begin VB.PictureBox picBPLTrophy 
      AutoSize        =   -1  'True
      Height          =   1680
      Left            =   3000
      Picture         =   "BPL.frx":C11A
      ScaleHeight     =   1620
      ScaleWidth      =   1620
      TabIndex        =   13
      Top             =   4080
      Width           =   1680
   End
   Begin VB.PictureBox picBPLLogo 
      AutoSize        =   -1  'True
      Height          =   1725
      Left            =   480
      Picture         =   "BPL.frx":14A0C
      ScaleHeight     =   1665
      ScaleWidth      =   1770
      TabIndex        =   12
      Top             =   4080
...
'frmBPL (Barclays Premier League, English soccer)
'Written by: Sean Egan
'Written on: 3/21/09
'This form allows the user to bet on English soccer games.
...
Private Sub cmdDisplay_Click()
    ...
    'Open the file
    Open App.Path & "\BPLGames.txt" For Input As #1
