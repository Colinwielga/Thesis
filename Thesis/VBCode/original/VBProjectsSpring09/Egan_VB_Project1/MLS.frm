VERSION 5.00
Begin VB.Form frmMLS 
   BackColor       =   &H00808000&
   Caption         =   "Major League Soccer (U.S.)"
   ClientHeight    =   6225
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7305
...
'frmMLS (Major League Soccer, U.S. soccer)
'Written by: Sean Egan
'Written on: 3/21/09
'This form allows the user to bet on U.S. soccer games.
...
Private Sub cmdDisplay_Click()
    ...
    'Open the file
    Open App.Path & "\MLSGames.txt" For Input As #1
