VERSION 5.00
Begin VB.Form frmNCAAF 
   BackColor       =   &H00FFFFFF&
   Caption         =   "NCAA Football"
   ClientHeight    =   6780
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7035
   ...
   Begin VB.ListBox lstGames 
      Height          =   1410
      ItemData        =   "NCAAF.frx":1C9D0
      Left            =   240
      List            =   "NCAAF.frx":1C9D2
      Style           =   1  'Checkbox
      TabIndex        =   4
      Top             =   1320
      Width           =   4815
...
'frmNCAAF (NCAA Football)
'Written by: Sean Egan
'Written on: 3/20/09
'This form allows the user to bet on college football games.
...
Private Sub cmdDisplay_Click()
    ...
    'Open the file
    Open App.Path & "\NCAAFGames.txt" For Input As #1
