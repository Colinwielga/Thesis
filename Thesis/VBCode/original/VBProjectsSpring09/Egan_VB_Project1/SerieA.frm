VERSION 5.00
Begin VB.Form frmSerieA 
   BackColor       =   &H000000C0&
   Caption         =   "Serie A (Italy)"
   ClientHeight    =   6645
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7425
   ...
   Begin VB.ListBox lstGames 
      Height          =   1185
      ItemData        =   "SerieA.frx":228C6
      Left            =   240
      List            =   "SerieA.frx":228C8
      Style           =   1  'Checkbox
      TabIndex        =   4
      Top             =   1320
      Width           =   4815
...
'frmSerieA (Italian soccer)
'Written by: Sean Egan
'Written on: 3/21/09
'This form allows the user to bet on Italian soccer games.
...
Private Sub cmdDisplay_Click()
    ...
    'Open the file
    Open App.Path & "\SerieAGames.txt" For Input As #1
