...
Begin VB.Form frmQ5 
   ...
   Begin VB.Label lblQuestion 
      BackColor       =   &H80000010&
      Caption         =   "How many different colors can Hubble Telescope record? "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
'the possibility of clicking on the Fifty Fifty button on the following form. Computer and Google hint buttons display
'message boxes indicating the more likely answer choice and eliminate the possibility of clicking those hint buttons on
'the following form.  There is also a countdown timer that gives the user 40 seconds to answer the questions.
...
If Computer = 1 Then
    ...
    MsgBox "There is a " & FormatPercent(0.68, 0) & " possibility that the answer is " & cmdA.Caption & " or " & cmdB.Caption & ".", , "CPU Output"
...
MsgBox "Google reports that " & Chr(13) & Chr(13) & cmdB.Caption & Chr(13) & cmdC.Caption & Chr(13) & Chr(13) & "had more clicks than " & Chr(13) & Chr(13) & cmdA.Caption & Chr(13) & cmdD.Caption, , "Google Search"
