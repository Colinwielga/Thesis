...
Begin VB.Form frmQ4 
   ...
   Begin VB.Label lblQuestion 
      BackColor       =   &H80000010&
      Caption         =   "Image called ""Mother and Child"", by Heather Ackroyd and Dan Harvey, was made out of _________ . "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
If Computer = 1 Then
    ...
    MsgBox "There is a " & FormatPercent(0.68, 0) & " possibility that the answer is " & cmdD.Caption & " or " & cmdB.Caption & ".", , "CPU Output"
