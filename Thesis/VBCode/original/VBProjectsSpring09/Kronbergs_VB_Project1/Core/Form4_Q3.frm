...
Begin VB.Form frmQ3 
   ...
   Begin VB.Label lblQuestion 
      BackColor       =   &H80000010&
      Caption         =   "What is the name of this camera?"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
...
If Computer = 1 Then
    ...
    MsgBox "There is a " & FormatPercent(0.83, 0) & " possibility that the answer is " & cmdD.Caption & " or " & cmdA.Caption & ".", , "CPU Output"
...
MsgBox "Google reports that " & Chr(13) & Chr(13) & cmdA.Caption & Chr(13) & cmdD.Caption & Chr(13) & Chr(13) & "had more clicks than " & Chr(13) & Chr(13) & cmdC.Caption & Chr(13) & cmdB.Caption, , "Google Search"
