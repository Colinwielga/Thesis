...
Private Sub cmdsend_Click()
    Dim typed As String
    typed = "Richard Motzko: " & txttyped.Text
...
Private Sub Time2_Timer()
    If gueststatus = 0 Then
        lblheader.Caption = "MiM: Guest has gone off-line..."
        txttyped.Visible = False
    ElseIf gueststatus = 1 Then
        lblheader.Caption = "MiM: chat with Guest"
