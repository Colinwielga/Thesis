...
MsgBox ("This Dogmingo is very rare, Jimmy's is currently the only pet store with one in stock"), vbInformation
End Sub
...
Private Sub cmdHedgehog_Click()
MsgBox ("This prickly little fellow gets along great with the kids and any other pets you may already own"), vbInformation
End Sub
...
Private Sub cmdNessy_Click()
MsgBox ("Another Rare Catch, the Loch Ness Monster is 500 feet long and weighs a massive 6 tons. We at Jimmy's suggest an outdoor pool to store your new pet."), vbInformation
End Sub
...
MsgBox ("These rare crawlers are not easy to come by, get them while they're fresh"), vbInformation
End Sub
