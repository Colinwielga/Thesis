...
Private Sub cmdBlackberry_Click()
    ...
    picWhiteRating.Print "70.2"
    picWhiteSlope.Print "121"
    picGoldRating.Print "67.7"
    picGoldSlope.Print "118"
...
Private Sub cmdInputRating_Click()
    ...
    txtFourthSlope.Text = txtFirstSlope.Text
...
Private Sub cmdStore_Click()
    If txtFirstRating.Text = "" Or txtSecondRating.Text = "" Or txtThirdRating.Text = "" Or txtFourthRating.Text = "" Or txtFifthRating.Text = "" Or txtFirstSlope.Text = "" Or txtSecondSlope.Text = "" Or txtThirdSlope.Text = "" Or txtFourthSlope.Text = "" Or txtFifthSlope.Text = "" Then
    ...
    Else
        ...
        ThirdRating = txtThirdRating.Text
        FourthRating = txtFourthRating.Text
        FifthRating = txtFifthRating.Text
    
        FirstSlope = txtFirstSlope.Text
        SecondSlope = txtSecondSlope.Text
        ThirdSlope = txtThirdSlope.Text
        FourthSlope = txtFourthSlope.Text
        FifthSlope = txtFifthSlope.Text
    
        DiffArr(1) = ((FirstScore - FirstRating) * 113) / FirstSlope
        DiffArr(2) = ((SecondScore - SecondRating) * 113) / SecondSlope
        DiffArr(3) = ((ThirdScore - ThirdRating) * 113) / ThirdSlope
        DiffArr(4) = ((FourthScore - FourthRating) * 113) / FourthSlope
        DiffArr(5) = ((FifthScore - FifthRating) * 113) / FifthSlope
...
Private Sub cmdTerritory_Click()
    ...
    picWhiteRating.Print "71.0"
    picWhiteSlope.Print "121"
    picGoldRating.Print "69.3"
    picGoldSlope.Print "116"
    picRedRating.Print "69.0"
...
Private Sub Form_Activate()
    ...
    picFirstScore.Print FirstScore
    picSecondScore.Print SecondScore
