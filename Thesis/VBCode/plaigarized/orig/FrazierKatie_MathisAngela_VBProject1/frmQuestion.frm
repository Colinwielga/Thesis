...
Private Sub cmdEnterAnswer_Click()
    ...
    If UCase(UserAnswer) <> "A" And UCase(UserAnswer) <> "B" And UCase(UserAnswer) <> "C" And UCase(UserAnswer) <> "D" Then
  ...
  'It appears from questions 6-8.
    If J >= 6 Then                      'Check to see if the final answer form should be displayed for this quesiton.
