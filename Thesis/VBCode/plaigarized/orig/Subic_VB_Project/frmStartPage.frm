...
Dim Gender As String, Age As Single
    ...
    Age = InputBox(" Enter your Age.", "Age")
       ...
       If (Gender = "M" Or Gender = "F") And Age >= 5 And Age < 18 Then
                ...
                frmBicycle.Show
        ElseIf Gender = "M" And Age >= 18 And Age <= 21 Then
                'hide Start page from user
                frmStartPage.Hide
        ...
        ElseIf Gender = "M" And Age > 21 And Age <= 24 Then
                ...
                frmTrabantS.Show
        ElseIf Gender = "M" And Age > 24 And Age <= 35 Then
                'hide Start page from user
                frmStartPage.Hide
                'show Old Fiat page to user
                frmOldFiat.Show
        ElseIf (Gender = "M" Or Gender = "F") And Age > 35 And Age <= 70 Then
                'hide Start page from user
                frmStartPage.Hide
                'show Beetle page to user
                frmBeetle.Show
        ElseIf Gender = "F" And Age >= 18 And Age <= 21 Then
                'hide Start page from user
                frmStartPage.Hide
                'show Fiat 500 page to user
                frmNewFiat.Show
        ElseIf Gender = "F" And Age > 21 And Age <= 24 Then
                'hide Start page from user
                frmStartPage.Hide
                'show Mini page to user
                frmMini.Show
        ElseIf Gender = "F" And Age > 24 And Age <= 35 Then
                'hide Start page from user
                frmStartPage.Hide
