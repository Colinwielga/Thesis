...
Private Sub cmdflop_Click() 'this button takes you to the menu
    frmWelcome.Hide
    frmMenu.Show
    frmPoll.Hide
    frmData.Hide
...
Private Sub cmdrec_Click() 'this button sorts the stats by receptions
    picResults.Cls
    Dim Pos As Integer
    Dim X As Integer
    Dim Pass As Integer
...
Private Sub cmdsearch_Click() 'this button searches for a player and then gives you their stats
    Dim S As String, Found As Boolean, I As Integer
    picResults.Cls
    Found = False
