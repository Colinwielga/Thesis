...
Begin VB.Form frmMusic 
   ...
   Begin VB.OLE OLE8 
      ...
      Height          =   1215
      Left            =   12000
      OleObjectBlob   =   "frmMusic.frx":0000
   ...
   Begin VB.OLE OLE7 
      ...
      Height          =   1335
      Left            =   7440
      OleObjectBlob   =   "frmMusic.frx":24018
   ...
   Begin VB.OLE OLE6 
      ...
      Height          =   1335
      Left            =   5280
      OleObjectBlob   =   "frmMusic.frx":5D430
   ...
   Begin VB.OLE OLE5 
      ...
      Height          =   1215
      Left            =   9720
      OleObjectBlob   =   "frmMusic.frx":77648
   ...
   Begin VB.OLE OLE4 
      ...
      Height          =   1215
      Left            =   4080
      OleObjectBlob   =   "frmMusic.frx":A5460
   ...
   Begin VB.OLE OLE3 
      ...
      Height          =   1095
      Left            =   840
      OleObjectBlob   =   "frmMusic.frx":BCC78
   ...
   Begin VB.OLE OLE2 
      ...
      Height          =   1215
      Left            =   480
      OleObjectBlob   =   "frmMusic.frx":FA090
   ...
   Begin VB.OLE OLE1 
      ...
      Height          =   1215
      Left            =   3000
      OleObjectBlob   =   "frmMusic.frx":133AA8
...
Private Sub cmdMain_Click() 'this button shows the main menu
    frmWelcome.Hide
    frmMenu.Show
    frmPoll.Hide
    frmData.Hide
...
Private Sub cmdNext_Click() 'this button shows the next form
    frmWelcome.Hide
    frmMenu.Hide
    frmPoll.Hide
    frmData.Hide
