...
Private Sub cmdCompute_Click() 'this button computes your awesomeness
    ...
    Select Case A
        Case Is >= 90
            picResults.Print "Good Choice. Go Pack Go!"
        Case 70 To 89
            picResults.Print "You can do a little better than that!"
        Case 40 To 69
            picResults.Print "You must not know football very well."
        Case 0 To 39
            picResults.Print "Well hey there Viking fan, how are those Super Bowls treating ya?"
        Case Else
            picResults.Print "What are you doing?"
    End Select
End Sub
