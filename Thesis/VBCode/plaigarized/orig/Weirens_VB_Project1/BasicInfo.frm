...
Begin VB.Form frmBasicInfo 
   ...
   Begin VB.CheckBox chkNoClaust 
      ...
      Width           =   975
   End
   Begin VB.CheckBox chkYesClaust 
      BackColor       =   &H00FF0000&
      Caption         =   "Yes"
      BeginProperty Font 
         Name            =   "Californian FB"
   ...
   Begin VB.TextBox txtFirstName 
      ...
      Width           =   6015
   End
   Begin VB.Label lblClaustrophobic 
      Alignment       =   2  'Center
      BackColor       =   &H00FF0000&
      Caption         =   "Are You Claustrophobic at all?"
      BeginProperty Font 
         Name            =   "Californian FB"
         Size            =   12
         Charset         =   0
...
Option Explicit
Private Sub chkNoMRI_Click()
'This keeps the Claustrophobic buttons and labels visible on the form because the patient does not have any pacemakers, defibrillators etc.
'thus allowing for them to have an MRI and be asked further questions.
    chkYesClaust.Visible = True
    chkNoClaust.Visible = True
    lblClaustrophobic.Visible = True
End Sub
Private Sub chkYesMRI_Click()
'This hides the Claustrophobic buttons and labels from being visible on the form because the patient has a pacemaker, defibrillator etc.
'thus not allowing for them to have an MRI and be asked further questions.
    chkYesClaust.Visible = False
    chkNoClaust.Visible = False
    lblClaustrophobic.Visible = False
End Sub
...
End Sub
Private Sub cmdSubmitInfo_Click()
'Declaring the variables
Dim FirstName As String, LastName As String, ContrastAllergy As String, MRISafe As String, Claustrophobic As String
...
MsgBox "Thank you " & FirstName & " for submitting your information into our database. This will remain confidential.", , "Finalizing"
