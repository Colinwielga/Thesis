...
Dim Numbness As Boolean     'Declare the variables

Numbness = InputBox("Would you say that your numbness continues for extended periods of time? Type True or False.")

'If/Then statement for either one statement or the other with their own messages
If Numbness = True Then
...
Dim Swell As Integer

Swell = InputBox("Is the swelling of your leg accompanied with redness and/or pain? If YES type 1 and if NO type 2.")
...
'Declare the variables
Dim Tender As Integer

Tender = InputBox("On a scale from 1 to 5 with 5 being the most, how tender is your arm or leg?")
