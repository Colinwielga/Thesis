...
'Declare the variables
Dim Duration As Single, comment As String

Duration = InputBox("How long have you had your headache for? (please define by number of days it has been present)", "Additional Information")

'If/Then statement for large data value spreads
If Duration >= 90 Then
        comment = "wow! You have had a headache for 3 months or greater! You need to get to a physician's office immediately to get an order for an MRI and MRA of your head!"
        scan = "MRI And MRA"
    ElseIf Duration <= 89 And Duration >= 60 Then
        comment = "you have had a headache for quite sometime. I would suggest that you get a physician's order for an MRI of your head."
        scan = "MRI"
    ElseIf Duration <= 59 And Duration >= 30 Then
        comment = "your headache is borderline chronic. I would suggest that you get a physician's order for a CTA and CT scan of your head."
        scan = "CTA and CT"
    ElseIf Duration <= 29 And Duration >= 0 Then
        comment = "your headache is acute and at this time I would suggest that you see a physician for a possible CT scan of your head."
        scan = "possible CT"
End If

'Message box to print the results from the input received
MsgBox ("You say that you have had a headache for " & Duration & " days and I have to say that " & comment)
...
Hardness = InputBox("What type of lump do you have on your head/skull? Type 1 if it is hard, Type 2 if it is soft.")
