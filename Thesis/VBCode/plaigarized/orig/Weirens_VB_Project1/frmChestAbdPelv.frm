...
Dim PregnantOrNo As Integer, Male As Integer, Female As Integer
...
Dim Acute As String, Chronic As String, Answer As String

Answer = InputBox("For your RUQ abdominal pain please enter whether the pain is 1 - Acute or 2 - Chronic with Acute meaning short duration and chronic meaning long duration. Enter only the number 1 or 2.")
...
If Answer = 1 Then
    ...
    ElseIf Answer > 2 Or Answer < 1 Then
         MsgBox Left("Error!", 3)
