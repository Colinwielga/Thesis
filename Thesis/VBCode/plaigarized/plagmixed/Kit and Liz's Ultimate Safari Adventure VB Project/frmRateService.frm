...
Private Sub cmdRateService_Click()
    ...
    dddddd = InputBox("Enter the dddddd to rate the service 0 being the worst and 100 being the best, (0-100) ")
    ...
    End Select
    picResults.Print "With "; dddddd; " dddddd,"; Chr(10); "the grade you gave us is "; Grade; "."
End Sub
