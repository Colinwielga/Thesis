...
Dim Pass As Integer, Pos As Integer, Temp As String, I As Integer = 1
For Pass = 1 To Ctr
    For Pos = 1 To Ctr - 1
        If MLastName(Pos + 1) <= MLastName(Pos) Then
            Temp = MLastName(Pos)
...
Dim Pass As Integer = 1, Pos As Integer, Temp As String, I As Integer
Do While Pass <= Ctr
    For Pos = 1 To Ctr - 1
