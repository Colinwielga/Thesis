...
Private Sub ten_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
RunningTotal = RunningTotal + 3.99
...
Private Sub eleven_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
...
Private Sub twelve_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
RunningTotal = RunningTotal + 0.99
...
Private Sub thirteen_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
RunningTotal = RunningTotal + 1.5
...
Private Sub fourteen_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
RunningTotal = RunningTotal + 2.99
...
Private Sub fifteen_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
...
Private Sub sixteen_Click(Index As Integer)
'Subtracts the price form the total value of the user input punches and send a message box telling the remaning amount or overage, and displays the cost and a picture of the item
PicResults.Cls
Money = (Punches * 4.85)
