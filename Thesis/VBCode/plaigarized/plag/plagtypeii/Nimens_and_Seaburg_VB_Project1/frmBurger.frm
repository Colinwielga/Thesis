...
Option Explicit
Dim lkjy As Long, wetre As Long
'Man vs. Food
'frmBurger
...
'Matt's menu sorted by name
    ...
    For lkjy = 1 To I - 1
        For wetre = 1 To I - lkjy

    If MattItem(wetre) > MattItem(wetre + 1) Then
            PosItem = MattItem(wetre)
            MattItem(wetre) = MattItem(wetre + 1)
            MattItem(wetre + 1) = PosItem

            PosCost = MattCost(wetre)
            MattCost(wetre) = MattCost(wetre + 1)
            MattCost(wetre + 1) = PosCost
...
'5-8 menu sorted by Name
    ...
    If ClubItem(wetre) > ClubItem(wetre + 1) Then
            CItem = ClubItem(wetre)
            ClubItem(wetre) = ClubItem(wetre + 1)
            ClubItem(wetre + 1) = CItem

            CCost = ClubCost(wetre)
            ClubCost(wetre) = ClubCost(wetre + 1)
            ClubCost(wetre + 1) = CCost
...
'Matt's menu sorted by price
    ...
    If MattCost(wetre) < MattCost(wetre + 1) Then
            PosCost = MattCost(wetre)
            MattCost(wetre) = MattCost(wetre + 1)
            MattCost(wetre + 1) = PosCost
...
'5-8 menu sorted by price
    ...
    If ClubCost(wetre) < ClubCost(wetre + 1) Then
            CCost = ClubCost(wetre)
            ClubCost(wetre) = ClubCost(wetre + 1)
            ClubCost(wetre + 1) = CCost
