...
Private Sub cmdAlbany_Click()
    ...
    afafaf = InputBox("Enter first player's name", "Player 1")   'input player(s) name(s)
    rrrrr = InputBox("Enter second player's name (0 if no more players)", "Player 2")
    Select Case rrrrr
    Case "0"
        frmFront.Show
        frmStart.Hide
    Case Else
        qqqq = InputBox("Please enter third player's name (0 if no more players)", "Player 3")
        Select Case qqqq
        Case "0"
            frmStart.Hide
            frmFront.Show
...
' asdfk jdaskf jdsakfj dsaf
' asdlfkj dsaflksda fdsklafj
' asdlfjweoifjoweigfj
...
Private Sub cmdBlackberry_Click()
    ...
    afafaf = InputBox("Enter first player's name", "Player 1")   'input player(s) name(s)
    rrrrr = InputBox("Enter second player's name (0 if no player)", "Player 2")
    Select Case rrrrr
    Case "0"
        frmStart.Hide
        frmFront.Show
    Case Else
        qqqq = InputBox("Please enter third player's name (0 if no player)", "Player 3")
        Select Case qqqq
        Case "0"
            frmStart.Hide
            frmFront.Show
...
For uuuu = 1 To CTR - 1                                 'sorts data in array from smallest to largest value
    For Pos = 1 To CTR - uuuu
...
Private Sub cmdTerritory_Click()
    ...
    afafaf = InputBox("Enter first player's name", "Player 1")
    rrrrr = InputBox("Enter second player's name (0 if no player)", "Player 2")
    If rrrrr = "0" Then
        frmStart.Hide
        frmFront.Show
