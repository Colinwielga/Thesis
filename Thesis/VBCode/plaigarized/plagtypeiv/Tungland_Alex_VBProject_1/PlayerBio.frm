...
Ctr3 = 0
'Declare variables
Dim Found As Boolean, WT(1 To 50) As Integer, Debut(1 To 50) As Integer, U As Integer, Ctr3 As Integer, Name As String, Player(1 To 50) As String, DOB(1 To 50) As Integer, POB(1 To 50) As String, BT(1 To 50) As String, HT(1 To 50) As Single, CLG(1 To 50) As String
'open file
